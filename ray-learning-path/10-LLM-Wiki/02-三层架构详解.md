...
raw/
├── articles/
│   ├── 2026-04-karpathy-llm-wiki.md     # 网页文章转 Markdown
│   └── 2026-05-deepseek-v3-report.md
├── papers/
│   ├── 2024-attention-is-all-you-need.pdf
│   └── 2026-llm-orbit-taxonomy.pdf
├── notes/
│   └── conference-notes-2026.md          # 自己的笔记也可以
└── data/
...
│   └── deepseek-v3-report.md
├── entities/                   # 人物、组织、产品、工具
│   ├── karpathy-andrej.md
│   ├── openai.md
│   └── deepseek.md
├── concepts/                   # 思想、框架、方法、术语
│   ├── llm-wiki-methodology.md
│   ├── compiler-vs-interpreter.md
│   └── rag-retrieval-augmented-generation.md
├── comparisons/                # 对比分析（两个或多个概念/工具）
│   ├── llm-wiki-vs-rag.md
│   └── gpt-vs-llama-vs-deepseek.md
└── reports/                    # Lint 健康检查报告
    └── lint-2026-05-13.md
```
