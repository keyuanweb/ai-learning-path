...
```mermaid
flowchart TD
  full["完整 Spec<br/>SPEC-USER-001"] --> seg1["Segment 1<br/>注册接口 AC-01~04"]
  full --> seg2["Segment 2<br/>登录接口 AC-05~08"]
  full --> seg3["Segment 3<br/>密码重置 AC-09~11"]
...
| 按验收条件组 | 复杂业务流程 | AC-01~05 为一段，AC-06~10 为一段 |
...
### 当前进度
- ✅ Task-01~04 已完成（注册、登录、Token 刷新、权限中间件）
- 🔄 Task-05 进行中（密码重置）
- ⬜ Task-06~08 待处理
